...
public class SuperSwipeRefreshLayout extends ViewGroup {
            ...
            if (mRefreshing) {
                if (mNotify) {
                    if (usingDefaultHeader) {
                        ...
                        if (mCustomHeadView != null && mCustomHeadView instanceof OnPullRefreshListener) {
                            OnPullRefreshListener listener = (OnPullRefreshListener) mCustomHeadView;
                            listener.onRefresh();
                        }
                    }
                    if (mListener != null) {
    ...
    public abstract class DefaultOnPullRefresh implements OnPullRefreshListener {
